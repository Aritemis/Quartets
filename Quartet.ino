...
void partOne() {
  ...
  if (toggle) CircuitPlayground.playTone(part1[i], duration);
...
void partTwo() {
  ...
  if (toggle) CircuitPlayground.playTone(part2[i], duration);
...
void partThree() {
  ...
  if (toggle) CircuitPlayground.playTone(part3[i], duration);
...
void partFour() {
  ...
  if (toggle) CircuitPlayground.playTone(part4[i], duration);
